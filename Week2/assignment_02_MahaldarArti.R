...
person_df2 <- read.csv(file = '~/dsc520/data/tidynomicon/person.csv', stringsAsFactors = FALSE)
str(person_df2)
## Read the file `data/scores.csv` to `scores_df`
## Display summary statistics using the `summary()` function
scores_df <- read.csv(file = '~/dsc520/data/scores.csv')
summary(scores_df)
...
excel_sheets('C:/Users/Sandeep Raina/Documents/dsc520/data/G04ResultsDetail2004-11-02.xls')
...
voter_turnout_df1 <- read_excel('C:/Users/Sandeep Raina/Documents/dsc520/data/G04ResultsDetail2004-11-02.xls', sheet= "Voter Turnout", skip=1)
...
voter_turnout_df2 <- read_excel('C:/Users/Sandeep Raina/Documents/dsc520/data/G04ResultsDetail2004-11-02.xls', sheet= "Voter Turnout", skip=2)
...
db <- dbConnect(RSQLite::SQLite(), dbname = 'C:/Users/Sandeep Raina/Documents/dsc520/data/tidynomicon/example.db')
